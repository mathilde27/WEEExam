<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BookConferenceRoom.aspx.cs" Inherits="volunteer_BookConferenceRoom" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <asp:Label ID="conferenceRoomValueLabel" runat="server" Width="60px" Text="ConferenceRoom"></asp:Label>
