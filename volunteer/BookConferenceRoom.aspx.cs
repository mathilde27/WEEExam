...
public partial class volunteer_BookConferenceRoom : System.Web.UI.Page
{
    ...
    */
        ...
        {
            conferenceRoomValueLabel.Text = Session["conference"].ToString();
        }
        else
        {
            conferenceRoomValueLabel.Text = "Conference room1";
        }
    }
    ...
    protected void BookingButton_Click(object sender, EventArgs e)
    {
        ...
        sqlCmd.Parameters.AddWithValue("@theFacility", conferenceRoomValueLabel.Text);
